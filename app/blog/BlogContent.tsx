...
function ERPvsQBVisual() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      {/* Arrow */}
      <path d="M120 60 L155 60" stroke="url(#blog1)" strokeWidth="2" strokeLinecap="round" opacity="0.2" />
      <path d="M150 55 L157 60 L150 65" stroke="url(#blog1)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.2" />
      {/* BC side */}
      <g>
        ...
        <path d="M177 62 L185 56 L193 58 L201 52" stroke="#2563eb" strokeWidth="1" fill="none" opacity="0.15" strokeLinecap="round" />
        {[0, 1].map(i => (
          <rect key={i} x="173" y={76 + i * 10} width={60 - i * 15} height="4" rx="2" fill="#2563eb" opacity={0.08 - i * 0.02} />
        ))}
      </g>
      <defs>
  ...
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      <g>
        ...
        <path d="M60 75 L240 65" stroke="#dc2626" strokeWidth="1.5" strokeDasharray="4 3" fill="none" opacity="0.15" />
        <text x="244" y="62" fontSize="4" fill="#dc2626" fontFamily="Inter, sans-serif" opacity="0.2">Cost</text>
        {/* ROI line (growing) */}
        <path d="M60 90 Q100 82 130 65 Q160 48 200 35 Q230 25 240 22" stroke="url(#blog6)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
        <text x="244" y="20" fontSize="4" fill="#14b8a6" fontFamily="Inter, sans-serif" opacity="0.3">ROI</text>
        {/* Fill under ROI curve */}
        <path d="M60 90 Q100 82 130 65 Q160 48 200 35 Q230 25 240 22 V100 H60 Z" fill="url(#blog6)" opacity="0.03" />
        {/* Breakeven point */}
        <g>
    ...
    <>
      ...
      <section className="pb-section pt-4">
        <div className="container-apple">
          ...
          <FadeIn className="mt-12 max-w-md mx-auto text-center">
