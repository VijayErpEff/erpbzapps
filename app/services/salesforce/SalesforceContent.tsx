...
function ImplementationSVG() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      <rect x="40" y="40" width="55" height="6" rx="3" fill="#00A1E0" opacity="0.25" />
      <rect x="40" y="52" width="70" height="6" rx="3" fill="#00A1E0" opacity="0.15" />
      <rect x="40" y="64" width="45" height="6" rx="3" fill="#14b8a6" opacity="0.2" />
      <rect x="40" y="76" width="60" height="6" rx="3" fill="#00A1E0" opacity="0.15" />
      {/* Toggle switches */}
      <rect x="120" y="40" width="24" height="10" rx="5" fill="#14b8a6" opacity="0.35" />
      <circle cx="140" cy="45" r="4" fill="#14b8a6" opacity="0.6" />
      <rect x="120" y="56" width="24" height="10" rx="5" fill="#00A1E0" opacity="0.25" />
      ...
      />
      <rect x="185" y="44" width="40" height="4" rx="2" fill="#00A1E0" opacity="0.2" />
      <rect x="185" y="50" width="28" height="3" rx="1.5" fill="#86868b" opacity="0.15" />
      ...
      />
      <rect x="185" y="89" width="35" height="4" rx="2" fill="#14b8a6" opacity="0.2" />
      <rect x="185" y="95" width="25" height="3" rx="1.5" fill="#86868b" opacity="0.15" />
...
function CustomizationSVG() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      {/* Code lines - Apex */}
      <rect x="35" y="32" width="16" height="4" rx="2" fill="#2563eb" opacity="0.4" />
      <rect x="55" y="32" width="40" height="4" rx="2" fill="#00A1E0" opacity="0.25" />
      <rect x="100" y="32" width="20" height="4" rx="2" fill="#14b8a6" opacity="0.3" />

      <rect x="45" y="42" width="25" height="4" rx="2" fill="#14b8a6" opacity="0.3" />
      <rect x="75" y="42" width="55" height="4" rx="2" fill="#86868b" opacity="0.15" />

      <rect x="45" y="52" width="30" height="4" rx="2" fill="#00A1E0" opacity="0.3" />
      <rect x="80" y="52" width="35" height="4" rx="2" fill="#2563eb" opacity="0.2" />

      <rect x="45" y="62" width="50" height="4" rx="2" fill="#86868b" opacity="0.12" />
      <rect x="35" y="72" width="20" height="4" rx="2" fill="#2563eb" opacity="0.4" />

      <rect x="45" y="82" width="35" height="4" rx="2" fill="#14b8a6" opacity="0.25" />
      <rect x="85" y="82" width="40" height="4" rx="2" fill="#00A1E0" opacity="0.2" />

      <rect x="35" y="92" width="18" height="4" rx="2" fill="#2563eb" opacity="0.35" />
      ...
      {/* Component blocks */}
      <rect x="188" y="32" width="64" height="18" rx="5" fill="#00A1E0" opacity="0.08" stroke="#00A1E0" strokeWidth="0.5" />
      ...
      <rect x="188" y="55" width="64" height="18" rx="5" fill="#14b8a6" opacity="0.08" stroke="#14b8a6" strokeWidth="0.5" />
      ...
      <rect x="188" y="78" width="64" height="18" rx="5" fill="#2563eb" opacity="0.08" stroke="#2563eb" strokeWidth="0.5" />
...
function IntegrationSVG() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      />
      {/* Mini bar chart */}
      <rect x="210" y="96" width="6" height="10" rx="1" fill="#2563eb" opacity="0.3" />
      <rect x="220" y="90" width="6" height="16" rx="1" fill="#2563eb" opacity="0.4" />
      <rect x="230" y="84" width="6" height="22" rx="1" fill="#2563eb" opacity="0.5" />
      <rect x="208" y="82" width="30" height="3" rx="1.5" fill="#2563eb" opacity="0.2" />

      {/* Connecting lines to central cloud */}
      <line x1="80" y1="27" x2="113" y2="44" stroke="#2563eb" strokeWidth="1.2" strokeDasharray="4 3" opacity="0.3" />
      <line x1="200" y1="27" x2="148" y2="44" stroke="#14b8a6" strokeWidth="1.2" strokeDasharray="4 3" opacity="0.3" />
      <line x1="80" y1="92" x2="113" y2="58" stroke="#00A1E0" strokeWidth="1.2" strokeDasharray="4 3" opacity="0.3" />
      <line x1="200" y1="92" x2="148" y2="58" stroke="#2563eb" strokeWidth="1.2" strokeDasharray="4 3" opacity="0.3" />
    </svg>
  );
}
...
function DataMigrationSVG() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      <rect x="22" y="30" width="40" height="4" rx="2" fill="#ef4444" opacity="0.2" />
      <rect x="25" y="38" width="50" height="4" rx="2" fill="#86868b" opacity="0.15" />
      <rect x="20" y="46" width="55" height="4" rx="2" fill="#eab308" opacity="0.2" />
      <rect x="28" y="54" width="30" height="4" rx="2" fill="#86868b" opacity="0.12" />
      <rect x="22" y="62" width="48" height="4" rx="2" fill="#ef4444" opacity="0.15" />
      <rect x="30" y="70" width="35" height="4" rx="2" fill="#86868b" opacity="0.1" />
      <rect x="24" y="78" width="42" height="4" rx="2" fill="#eab308" opacity="0.18" />
      <rect x="26" y="86" width="38" height="4" rx="2" fill="#86868b" opacity="0.1" />
      ...
      <line x1="100" y1="42" x2="120" y2="42" stroke="#00A1E0" strokeWidth="0.8" opacity="0.3" />
      <line x1="100" y1="52" x2="122" y2="52" stroke="#00A1E0" strokeWidth="0.8" opacity="0.3" />
      <line x1="100" y1="62" x2="122" y2="62" stroke="#00A1E0" strokeWidth="0.8" opacity="0.3" />
      <line x1="100" y1="72" x2="120" y2="72" stroke="#00A1E0" strokeWidth="0.8" opacity="0.3" />
      ...
      />
      <rect x="154" y="72" width="25" height="3" rx="1.5" fill="#14b8a6" opacity="0.25" />
      <rect x="156" y="78" width="18" height="3" rx="1.5" fill="#86868b" opacity="0.12" />
      ...
      <rect x="222" y="30" width="40" height="5" rx="2.5" fill="#00A1E0" opacity="0.3" />
      <rect x="222" y="40" width="40" height="5" rx="2.5" fill="#00A1E0" opacity="0.2" />
      <rect x="222" y="50" width="40" height="5" rx="2.5" fill="#00A1E0" opacity="0.2" />
      <rect x="222" y="60" width="40" height="5" rx="2.5" fill="#00A1E0" opacity="0.2" />
      <rect x="222" y="70" width="40" height="5" rx="2.5" fill="#14b8a6" opacity="0.2" />
      <rect x="222" y="80" width="40" height="5" rx="2.5" fill="#14b8a6" opacity="0.2" />
...
function AdminSupportSVG() {
  return (
    <svg viewBox="0 0 280 120" fill="none" className="w-full h-full">
      ...
      {/* Metric cards row */}
      {/* Active Users */}
      <rect x="100" y="34" width="68" height="30" rx="6" fill="#00A1E0" opacity="0.06" />
      ...
      <path d="M145 56 L148 52 L152 54 L156 48 L160 50" stroke="#14b8a6" strokeWidth="1.2" fill="none" strokeLinecap="round" />

      {/* API Calls */}
      <rect x="175" y="34" width="68" height="30" rx="6" fill="#14b8a6" opacity="0.06" />
      ...
      {/* User management row */}
      <rect x="100" y="72" width="143" height="28" rx="6" fill="#f5f5f7" opacity="0.8" />
      {/* User avatars */}
      <circle cx="114" cy="86" r="7" fill="#00A1E0" opacity="0.2" />
      <circle cx="114" cy="84" r="2.5" fill="#00A1E0" opacity="0.4" />
      <path d="M110 90 Q114 88 118 90" fill="#00A1E0" opacity="0.3" />

      <circle cx="132" cy="86" r="7" fill="#14b8a6" opacity="0.2" />
      <circle cx="132" cy="84" r="2.5" fill="#14b8a6" opacity="0.4" />
      <path d="M128 90 Q132 88 136 90" fill="#14b8a6" opacity="0.3" />

      <circle cx="150" cy="86" r="7" fill="#2563eb" opacity="0.2" />
      <circle cx="150" cy="84" r="2.5" fill="#2563eb" opacity="0.4" />
      <path d="M146 90 Q150 88 154 90" fill="#2563eb" opacity="0.3" />

      {/* Status bars */}
      <rect x="168" y="79" width="60" height="4" rx="2" fill="#e5e7eb" />
      <rect x="168" y="79" width="48" height="4" rx="2" fill="#14b8a6" opacity="0.5" />
      <rect x="168" y="88" width="60" height="4" rx="2" fill="#e5e7eb" />
      <rect x="168" y="88" width="38" height="4" rx="2" fill="#00A1E0" opacity="0.5" />

      {/* Sidebar health metrics */}
      <rect x="30" y="82" width="55" height="20" rx="5" fill="#14b8a6" opacity="0.06" />
...
function Customer360SVG() {
  return (
    <svg viewBox="0 0 80 60" fill="none" className="w-full h-full">
      {/* Central user avatar */}
      <circle cx="40" cy="24" r="10" fill="#00A1E0" opacity="0.15" />
      <circle cx="40" cy="21" r="3.5" fill="#00A1E0" opacity="0.4" />
      <path d="M34 30 Q40 27 46 30" fill="#00A1E0" opacity="0.3" />

      {/* Orbiting touchpoints */}
      <circle cx="40" cy="24" r="22" stroke="#00A1E0" strokeWidth="0.5" strokeDasharray="2 3" opacity="0.2" />
      {/* Data points on orbit */}
      <circle cx="18" cy="22" r="4" fill="#14b8a6" opacity="0.25" />
      <circle cx="62" cy="22" r="4" fill="#2563eb" opacity="0.25" />
      <circle cx="26" cy="42" r="4" fill="#00A1E0" opacity="0.25" />
      <circle cx="54" cy="42" r="4" fill="#14b8a6" opacity="0.25" />
...
function AutomationSVG() {
  return (
    <svg viewBox="0 0 80 60" fill="none" className="w-full h-full">
      ...
      {/* Gear 2 (smaller, static) */}
      <circle cx="55" cy="38" r="6" stroke="#14b8a6" strokeWidth="0.8" strokeDasharray="3 2" fill="#14b8a6" opacity="0.08" />
...
function MobileSVG() {
  return (
    <svg viewBox="0 0 80 60" fill="none" className="w-full h-full">
      ...
      <rect x="33" y="16" width="14" height="3" rx="1.5" fill="#00A1E0" opacity="0.3" />
      <rect x="33" y="22" width="10" height="2" rx="1" fill="#86868b" opacity="0.15" />
      <rect x="33" y="28" width="14" height="6" rx="2" fill="#14b8a6" opacity="0.12" />
      <rect x="33" y="37" width="14" height="6" rx="2" fill="#00A1E0" opacity="0.12" />

      {/* WiFi signal */}
      <path d="M60 16 Q64 10 68 16" stroke="#14b8a6" strokeWidth="1" fill="none" opacity="0.3" />
      <path d="M58 20 Q64 12 70 20" stroke="#14b8a6" strokeWidth="1" fill="none" opacity="0.2" />
...
function AppExchangeSVG() {
  return (
    <svg viewBox="0 0 80 60" fill="none" className="w-full h-full">
      {/* Grid of app blocks */}
      <rect x="10" y="8" width="16" height="16" rx="4" fill="#00A1E0" opacity="0.15" stroke="#00A1E0" strokeWidth="0.5" />
      <rect x="32" y="8" width="16" height="16" rx="4" fill="#14b8a6" opacity="0.15" stroke="#14b8a6" strokeWidth="0.5" />
      <rect x="54" y="8" width="16" height="16" rx="4" fill="#2563eb" opacity="0.15" stroke="#2563eb" strokeWidth="0.5" />

      <rect x="10" y="30" width="16" height="16" rx="4" fill="#2563eb" opacity="0.12" stroke="#2563eb" strokeWidth="0.5" />
      <rect x="32" y="30" width="16" height="16" rx="4" fill="#00A1E0" opacity="0.2" stroke="#00A1E0" strokeWidth="0.5" />
      <rect x="54" y="30" width="16" height="16" rx="4" fill="#14b8a6" opacity="0.12" stroke="#14b8a6" strokeWidth="0.5" />
      ...
      <path d="M40 52 L40 56 M38 54 L42 54" stroke="#00A1E0" strokeWidth="1.5" strokeLinecap="round" opacity="0.4" />
    </svg>
  );
}
