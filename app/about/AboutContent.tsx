  ...
  return (
    <svg viewBox="0 0 260 140" fill="none" className="w-full h-full">
      ...
      <g>
        ...
        <circle cx="64" cy="68" r="24" stroke="url(#cf-gauge)" strokeWidth="3" fill="none"
          strokeLinecap="round" strokeDasharray="150.8" strokeDashoffset="15"
          transform="rotate(-90 64 68)" />
        <text x="64" y="65" fontSize="14" fontWeight="800" fill="#1d1d1f" textAnchor="middle" fontFamily="Inter, sans-serif" opacity="0.8">98</text>
  ...
  return (
    <svg viewBox="0 0 260 140" fill="none" className="w-full h-full">
      ...
      <g>
        ...
        {[
          ...
          <g key={bar.label}>
            ...
            <rect x={bar.x} y={bar.y} width={bar.w} height="8" rx="4" fill={bar.color} opacity="0.2" />
            {/* Progress fill */}
            <rect x={bar.x} y={bar.y} width={bar.w * (i < 2 ? 1 : i === 2 ? 0.6 : 0)} height="8" rx="4" fill={bar.color} opacity="0.45" />
            {/* Checkmark for completed */}
            {i < 2 && (
              <path d={`M${bar.x + bar.w + 4} ${bar.y + 2} l2 2 4-4`}
      ...
      <g>
        ...
        <rect x="166" y="112" width="38" height="3" rx="1.5" fill="url(#tr-bar)" opacity="0.8" />
  ...
  return (
    <svg viewBox="0 0 260 140" fill="none" className="w-full h-full">
      ...
      <g>
        ...
        <circle cx="74" cy="62" r="20" stroke="url(#exc-ring)" strokeWidth="3" fill="none"
          strokeLinecap="round" strokeDasharray="125.6" strokeDashoffset="6.3"
          transform="rotate(-90 74 62)" />
        <text x="74" y="59" fontSize="12" fontWeight="800" fill="#1d1d1f" textAnchor="middle" fontFamily="Inter, sans-serif" opacity="0.7">A+</text>
      ...
      <g>
        ...
        {[
          ...
          <g key={stage.label}>
            ...
            <path d={`M${stage.x + 3} 44 l2 2 4-4`}
            ...
            {i < 3 && (
              <line x1={stage.x + 13} y1="44" x2={stage.x + 18} y2="44"
        ...
        <g key={col.label}>
          ...
          {Array.from({ length: Math.min(col.cards, 3) }).map((_, i) => (
            <g key={i}>
              ...
              {ci === 3 && (
                <path d={`M${col.x + 38} ${55 + i * 18} l1.5 1.5 3-3`}
...
function StoryVisual() {
  return (
    <svg viewBox="0 0 280 180" fill="none" className="w-full h-full">
      ...
      {/* Journey path */}
      <path d="M30 150 C50 140 60 120 80 115 S120 105 140 90 S170 65 190 55 S220 35 250 28"
      ...
      <g>
        ...
        {/* Handshake icon */}
        <path d="M86 90 L90 86 L96 92 L100 86 L104 90" stroke="#00A4EF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.25" />
      ...
      <g>
        ...
        {/* Chart bars */}
        {[0, 1, 2].map(i => (
          <rect key={i} x={160 + i * 7} y={46 - i * 4} width="4" height={8 + i * 4} rx="1" fill="#14b8a6" opacity={0.1 + i * 0.06} />
        ))}
      ...
      <g>
        ...
        {/* Rocket */}
        <path d="M244 12 L250 6 L256 12 M250 6 V18" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.3" />
